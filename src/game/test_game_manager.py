...
def test_game_over(game):
    game._grid._grid = np.array(
        [[5, 3, 1, 1], [3, 4, 2, 3], [1, 6, 4, 1], [4, 1, 2, 4],]
    ).astype(np.uint8)
    ...
    np.testing.assert_equal(
        game.get_state(),
        np.array([[32, 8, 2, 2], [8, 16, 4, 8], [2, 64, 16, 2], [16, 2, 4, 16],]),
    )
    ...
    np.testing.assert_equal(
        state[1:], np.array([[8, 16, 4, 8], [2, 64, 16, 2], [16, 2, 4, 16],])
    )
...
def test_is_game_over_when_tile_match_are_available(game):
    game._grid._grid = np.array(
        [[5, 2, 1, 1], [3, 4, 3, 5], [1, 6, 4, 1], [4, 1, 2, 4],]
    ).astype(np.uint8)
    ...
    np.testing.assert_equal(
        state[1:], np.array([[8, 16, 8, 32], [2, 64, 16, 2], [16, 2, 4, 16],])
    )
...
def test_available_actions_when_there_are_free_cells(game):
    game._grid._grid = np.array(
        [[5, 2, 1, 1], [3, 4, 0, 5], [1, 6, 4, 1], [4, 1, 2, 4],]
    ).astype(np.uint8)
...
def test_available_actions_when_there_are_no_free_cells(game):
    game._grid._grid = np.array(
        [[5, 2, 1, 1], [3, 4, 2, 5], [1, 6, 4, 1], [4, 1, 2, 4],]
    ).astype(np.uint8)
